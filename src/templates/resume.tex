...
\centerline{\textbf{\href{https://{+ resume.website +}}{Find a better version of my resume at {+ resume.website +}}}}
...
{% if job.achievements is defined %}
\vspace{-9pt}
  \begin{itemize}
    ...
    {% endfor %}
  \end{itemize}
{% elif job.description is defined %}
  \begin{quote}{{+ job.description +}}
  \end{quote}
{% endif %}
{% endfor %}
...
\textbf{{+ cert.name +}} \hfill \textbf{{+ cert.date +}} \\
{% endfor %}
